...
<body>
	...
	%>
		...
		<div class="box1">
			<div class="card mx-auto" style="width: 100%; top: 50px">
				...
				<div class="box1">
					<div class="card  mx-auto" style="width: 100% x;">
						<div class="card-body">
							<img src="data:image/*;base64,<%=lg.getGoodsImg()%>"
