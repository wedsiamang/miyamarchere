...
<body>
	...
	<div class="headbox">
		...
		<div class="main">
			<h1 class="text-center"><%=gs.getShop_name() %></h1></div><br>
			<h3 class="card-text text-center">販売時間：<%=gs.getStart_time() %>～<%=gs.getEnd_time() %></h3> 
			<div class="box1">
			...
			<div class="card mb-4 mx-auto "style="max-width: 850px; top: 100px; bottom: 100px;">
				<h4 class="card-title text-center">店舗情報</h4><br>
				<div class="row no-gutters">
					<div class="col-md-4">
						<div class="card width: 18rem; border-light">
							<form name="form"action="/miyama1/IntroductionShopServlet" method="post">
    							<input type="hidden" name="shop_name"value="<%=gs.getShop_name() %>">
								<button id="btn" class="btn-outline">
								<img src="data:image/*;base64,<%=gs.getShop_img() %>"width="250px"height="250px" >
								</button>
							</form>
						</div>
 					</div>
						...
						<div class="card border-light"style="width: 18rem;">
							<div class="card-body ">
								...
								<h4 class="card-title text-center"><%=gs.getShop_name() %></h4>
								 ...
								 <h5 class="card-text text-center">営業時間<%=gs.getBusiness_hour() %>時</h5><br>
