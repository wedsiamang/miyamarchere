			...
			<div class="box1">
				<div class="card2  mx-auto" style="width: 1200px;">
					<div class="card-body2">
						<br> <br>
						<h1 class="card-title text-center"><%=i.getShopName()%></h1><br>
						<h3 class="text-center"><%=i.getNearBy()%></h3>
						<img src="data:image/*;base64,<%=i.getShopImg()%>" width="1200px"
							height="600px"> <br> <br>
		...
		<div class="box3">
			<div class="card mx-auto" style="max-width: 1000px;">
				<div class="row no-gutters">
					...
					<div class="col-md-8">
						<div class="card-body">
							<h4 class="card-title text-center"><%=i.getShopName()%></h4><br>
