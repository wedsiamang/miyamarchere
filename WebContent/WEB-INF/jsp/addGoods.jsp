...
<div class="footerFixed">
  	<div class="main">
		<div class="mx-auto" style="width:1000px">
			<br>
			<form action="/miyama1/AddGoodsServlet" method="post"enctype="multipart/form-data">
			<div class="form-row">
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<select  name="kinds" class="form-control" required>
				...
				<div class="mb-3">
					...
					<input type="text"class="form-control"  name="goods_name"placeholder="商品名" required>	
				</div>
				<div class="mb-3">
					<label for="quantity" class="form-label">個数</label>
					<input type="number" class="form-control"  name="quantity"placeholder="個数" min="1" value="1" required>
				</div>
				<div class="mb-3">
			...
			<div class="form-row">
				<div class="mb-3">
					...
					<input type="number" class="form-control"  required name="list_price"placeholder="定価" required >
				</div>
				<div class="mb-3">
					<label for="selling_price" class="form-label">出品価格</label>
					<input type="number" class="form-control" name="selling_price"placeholder="出品価格" required>
				</div>
			</div>
			<div class="form-row">
				<div class="mb-3">
					<label for="start_time" class="form-label">販売開始時間</label>
					<input type="datetime-local" class="form-control"  name="start_time"placeholder="いつから" required>
				</div>
				<div class="mb-3">
					<label for="end_time" class="form-label">販売終了時間</label>
					<input type="datetime-local"   class="form-control" name="end_time"placeholder="いつまで" required>
				</div>
			</div>
			<div class="mb-3">
				<label for="goods_comment" class="form-label">コメント</label>
				<input type="text" class="form-control"  name="goods_comment"placeholder="コメント">
			</div>
			<div class="form-row">
