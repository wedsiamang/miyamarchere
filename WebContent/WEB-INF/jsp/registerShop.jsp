...
<link rel="stylesheet" href="css/registerShop.css">
<link rel="stylesheet"
	...
	<div class="all">
		...
		<div class="mx-auto" style="width: 90%">
			...
			<form action="/RegisterShopServlet" method="post"
				...
				<div class="mb-3">
					<label for="file" class="form-label">店舗紹介画像</label> <input
						type="file" name="sImg" accept="image/*" required>
				</div>
				<div class="mb-3">
			...
			<div style="text-align: center;">
				<a href="/LoginServlet">login</a> <a href="/IndexServlet">TOPへ</a>
			</div>
