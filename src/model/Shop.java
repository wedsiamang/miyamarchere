...
public class Shop implements Serializable {
	...
	public Shop(int shopId,String shopName,String password,String tel,String address,String email,String businessHour,String shopImg,String shopComment,String nearBy,String dateTime) {
		this.shopId=shopId;
		this.shopName=shopName;
		this.password=password;
		this.tel=tel;
