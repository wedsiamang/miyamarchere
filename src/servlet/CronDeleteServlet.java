...
public class CronDeleteServlet extends HttpServlet {
	...
	//	selling_price=Integer.parseInt(request.getParameter("selling_price"));
		...
		cdao.return_goods(goods_id, shop_name, kinds, goods_name, quantity, list_price, selling_price, part, goods_comment, discount_rate, start_time, end_time, unit);
		//endgoodsテーブルを全削除する
		cdao.delete_endgoods();
